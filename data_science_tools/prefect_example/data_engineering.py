...
@task(target="{date:%a %b %d %H:%M:%S %Y}/{task_name}_output", result = LocalResult(dir='data/processed'))
...
@task(log_stdout=True, target="{date:%a %b %d %H:%M:%S %Y}/{task_name}_output", result = LocalResult(dir='data/processed'))
